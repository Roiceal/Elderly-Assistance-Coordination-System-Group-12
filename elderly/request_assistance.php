...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-light fixed-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="elder_about_us.php">About Us</a></li>
        </ul>
   ...
   <nav class="sidebar" id="sidebar">
    <ul class="sidebar-menu">
      ...
      <li class="menu-item"><a href="/privacy_and_policy.php" class="menu-link">Privacy and Policy</a></li>
    </ul>
  </nav>
  ...
  <div class="container mt-5 pt-5">
    <div class="request-form">
      ...
      <form action="request_assistance_process.php" method="POST">

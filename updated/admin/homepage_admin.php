...
<body>
 <nav class="navbar navbar-expand-lg bg-light fixed-top">
  ...
  <p style="text-align: center;">The Users and Assistance Requests are working, the rest are still on progress.</a></p>
  <nav class="sidebar" id="sidebar">
    <ul class="sidebar-menu">
      ...
      <li class="menu-item"><a href="rfid/forattendance/attendance.html" class="menu-link">Attendance</a></li>

...
// Initialize $errors to avoid variable errors
$errors = array();

$showSuccessPopup = false; // Flag to control popup display
...
if (isset($_POST["submit"])) {
    ...
    // Validation (populate $errors array)
    ...
    if (count($errors) > 0) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                $showSuccessPopup = true; // Set flag for success
            } else {
...
<div class="register">
    <form action="register.php" method="POST">
        ...
        <div class="box">
            <select name="role" id="role" required class="form-control select-role">
...
<script>
    if (typeof Swal !== 'undefined') {
        ...
        alert('SweetAlert2 not loaded. Registration successful! Redirecting...');
